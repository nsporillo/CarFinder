...
CREATE TABLE IF NOT EXISTS Dealer(DealerID INT PRIMARY KEY, Name VARCHAR(255), Street VARCHAR(255), City VARCHAR(255), ZIP INT, State VARCHAR(255), Phone INT);
CREATE TABLE IF NOT EXISTS Customer(CustomerID INT PRIMARY KEY, FirstName VARCHAR(255), LastName VARCHAR(255), Street VARCHAR(255), State VARCHAR(255), ZIP INT, Phone VARCHAR(255), Gender INT, Income INT);
